...
import (
	...
	"github.com/prestonchoate/aoc-2023/solutions/day10"
	"github.com/prestonchoate/aoc-2023/solutions/day11"
	...
	"github.com/prestonchoate/aoc-2023/solutions/day9"
)
...
func main() {
	...
	case 9:
		val := 0
		input := solutions.GetInputString("inputs/day9.txt")
		if *partSelect == 1 {
			val = day9.SolvePart1(input)
		}
		if *partSelect == 2 {
			val = day9.SolvePart2(input)
		}

		printSolutionString(*daySelect, *partSelect, val)
	case 10:
		val := 0
		input := solutions.GetInputString("inputs/day10.txt")
		if *partSelect == 1 {
			val = day10.SolveP1(input)
		}
		if *partSelect == 2 {
			val = day10.SolveP2(input)
		}
	...
	case 11:
		val := 0
		input := solutions.GetInputString("inputs/day11.txt")
		if *partSelect == 1 {
			val = day11.SolveP1(input)
		}
		if *partSelect == 2 {
			val = day11.SolveP2(input)
		}
